...
class Map:
    ...
    def __repr__(self):
        return "%#x-%#x %#x %#x %s" % (self.start, self.end, self.size, self.fileoff, self.objfile)
...
def dump_target_memory_map(topdir):
...
# given a list of mappings dump it to a to a directory
